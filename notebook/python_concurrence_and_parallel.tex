...
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} fetch content size from a series of web sites}
        ...
        \PY{n}{urls} \PY{o}{=} \PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{http://tdlte\PYZhy{}report\PYZhy{}server.china.nsn\PYZhy{}net.net}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
                \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{http://10.56.78.25}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}
...
\tightlist
\item
  需求, 提供一个命令行终端输入模式, 如: ./syslog -l syslog\_1.txt,
...
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} \PYZhy{}*\PYZhy{} coding: utf\PYZhy{}8 \PYZhy{}*\PYZhy{}}
        ...
        \PY{k+kn}{from} \PY{n+nn}{selectors} \PY{k+kn}{import} \PY{n}{DefaultSelector}\PY{p}{,} \PY{n}{EVENT\PYZus{}WRITE}\PY{p}{,} \PY{n}{EVENT\PYZus{}READ}
        
        \PY{n}{selector} \PY{o}{=} \PY{n}{DefaultSelector}\PY{p}{(}\PY{p}{)}
        
        \PY{n}{stopped} \PY{o}{=} \PY{n+nb+bp}{False}
        
        
        \PY{k}{class} \PY{n+nc}{Future}\PY{p}{:}
            \PY{k}{def} \PY{n+nf+fm}{\PYZus{}\PYZus{}init\PYZus{}\PYZus{}}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{)}\PY{p}{:}
                \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{result} \PY{o}{=} \PY{n+nb+bp}{None}
                \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{\PYZus{}callbacks} \PY{o}{=} \PY{p}{[}\PY{p}{]}
        
            \PY{k}{def} \PY{n+nf}{add\PYZus{}done\PYZus{}callback}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{,} \PY{n}{fn}\PY{p}{)}\PY{p}{:}
                \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{\PYZus{}callbacks}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{fn}\PY{p}{)}
        
            \PY{k}{def} \PY{n+nf}{set\PYZus{}result}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{,} \PY{n}{result}\PY{p}{)}\PY{p}{:}
                \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{result} \PY{o}{=} \PY{n}{result}
                \PY{k}{for} \PY{n}{fn} \PY{o+ow}{in} \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{\PYZus{}callbacks}\PY{p}{:}
                    \PY{n}{fn}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{)}
        
        \PY{k}{class} \PY{n+nc}{Crawler}\PY{p}{(}\PY{n+nb}{object}\PY{p}{)}\PY{p}{:}
            \PY{n}{counter} \PY{o}{=} \PY{l+m+mi}{0}
            \PY{k}{def} \PY{n+nf+fm}{\PYZus{}\PYZus{}init\PYZus{}\PYZus{}}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{)}\PY{p}{:}
                \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{url} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{10.56.78.25}\PY{l+s+s1}{\PYZsq{}}
                \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{sock} \PY{o}{=} \PY{n+nb+bp}{None}
                \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{response} \PY{o}{=} \PY{l+s+sa}{b}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZsq{}}
        
            \PY{k}{def} \PY{n+nf}{fetch}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{)}\PY{p}{:}
                \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{sock} \PY{o}{=} \PY{n}{socket}\PY{o}{.}\PY{n}{socket}\PY{p}{(}\PY{p}{)}
                \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{sock}\PY{o}{.}\PY{n}{setblocking}\PY{p}{(}\PY{n+nb+bp}{False}\PY{p}{)}
                \PY{k}{try}\PY{p}{:}
                    \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{sock}\PY{o}{.}\PY{n}{connect}\PY{p}{(}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{10.56.78.25}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+m+mi}{80}\PY{p}{)}\PY{p}{)}
                \PY{k}{except}\PY{p}{:}
                    \PY{k}{pass}
                \PY{n}{selector}\PY{o}{.}\PY{n}{register}\PY{p}{(}\PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{sock}\PY{o}{.}\PY{n}{fileno}\PY{p}{(}\PY{p}{)}\PY{p}{,} \PY{n}{EVENT\PYZus{}WRITE}\PY{p}{,} \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{connected}\PY{p}{)}
        
            \PY{k}{def} \PY{n+nf}{connected}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{,} \PY{n}{key}\PY{p}{,} \PY{n}{mask}\PY{p}{)}\PY{p}{:}
                \PY{n}{selector}\PY{o}{.}\PY{n}{unregister}\PY{p}{(}\PY{n}{key}\PY{o}{.}\PY{n}{fd}\PY{p}{)}
                \PY{n}{get} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{GET / HTTP/1.0}\PY{l+s+se}{\PYZbs{}r}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s1}{HOST: 10.56.78.25}\PY{l+s+se}{\PYZbs{}r}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+se}{\PYZbs{}r}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s1}{.}\PY{l+s+s1}{\PYZsq{}}
                \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{sock}\PY{o}{.}\PY{n}{send}\PY{p}{(}\PY{n}{get}\PY{o}{.}\PY{n}{encode}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{ascii}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{)}
                \PY{n}{selector}\PY{o}{.}\PY{n}{register}\PY{p}{(}\PY{n}{key}\PY{o}{.}\PY{n}{fd}\PY{p}{,} \PY{n}{EVENT\PYZus{}READ}\PY{p}{,} \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{read\PYZus{}response}\PY{p}{)}
        
            \PY{k}{def} \PY{n+nf}{read\PYZus{}response}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{,} \PY{n}{key}\PY{p}{,} \PY{n}{mask}\PY{p}{)}\PY{p}{:}
                \PY{k}{global} \PY{n}{stopped}
                \PY{n}{chunk} \PY{o}{=} \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{sock}\PY{o}{.}\PY{n}{recv}\PY{p}{(}\PY{l+m+mi}{4096}\PY{p}{)}
                \PY{k}{if} \PY{n}{chunk}\PY{p}{:}
                    \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{response} \PY{o}{+}\PY{o}{=} \PY{n}{chunk}
                \PY{k}{else}\PY{p}{:}
                    \PY{n}{selector}\PY{o}{.}\PY{n}{unregister}\PY{p}{(}\PY{n}{key}\PY{o}{.}\PY{n}{fd}\PY{p}{)}
                    \PY{c+c1}{\PYZsh{}urls\PYZus{}todo.remove(self.url)}
                    \PY{n}{Crawler}\PY{o}{.}\PY{n}{counter} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
                    \PY{c+c1}{\PYZsh{}print(\PYZdq{}response:\PYZdq{},self.response)}
                    \PY{k}{if} \PY{n}{Crawler}\PY{o}{.}\PY{n}{counter} \PY{o}{==} \PY{l+m+mi}{10}\PY{p}{:}
                        \PY{n}{stopped} \PY{o}{=} \PY{n+nb+bp}{True}
        
        
        \PY{k}{def} \PY{n+nf}{loop}\PY{p}{(}\PY{p}{)}\PY{p}{:}
            \PY{k}{while} \PY{o+ow}{not} \PY{n}{stopped}\PY{p}{:}
                \PY{n}{events} \PY{o}{=} \PY{n}{selector}\PY{o}{.}\PY{n}{select}\PY{p}{(}\PY{p}{)}
                \PY{k}{for} \PY{n}{event\PYZus{}key}\PY{p}{,} \PY{n}{event\PYZus{}mask} \PY{o+ow}{in} \PY{n}{events}\PY{p}{:}
                    \PY{n}{callback} \PY{o}{=} \PY{n}{event\PYZus{}key}\PY{o}{.}\PY{n}{data}
                    \PY{n}{callback}\PY{p}{(}\PY{n}{event\PYZus{}key}\PY{p}{,} \PY{n}{event\PYZus{}mask}\PY{p}{)}
        
        \PY{k}{if} \PY{n+nv+vm}{\PYZus{}\PYZus{}name\PYZus{}\PYZus{}} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZus{}\PYZus{}main\PYZus{}\PYZus{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
            \PY{k+kn}{import} \PY{n+nn}{time}
            \PY{n}{start} \PY{o}{=} \PY{n}{time}\PY{o}{.}\PY{n}{time}\PY{p}{(}\PY{p}{)}
            \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{10}\PY{p}{)}\PY{p}{:}
                \PY{n}{crawler} \PY{o}{=} \PY{n}{Crawler}\PY{p}{(}\PY{p}{)}
                \PY{n}{crawler}\PY{o}{.}\PY{n}{fetch}\PY{p}{(}\PY{p}{)}
            \PY{n}{loop}\PY{p}{(}\PY{p}{)}
            \PY{k}{print}\PY{p}{(}\PY{n}{time}\PY{o}{.}\PY{n}{time}\PY{p}{(}\PY{p}{)} \PY{o}{\PYZhy{}} \PY{n}{start}\PY{p}{)}
\end{Verbatim}
...
\tightlist
\item
  协程(Co-routine)，Coroutine其实是corporate routine的缩写,
  即是协作式的例程。
\end{itemize}
...
\KeywordTok{def}\NormalTok{ B():}
    \BuiltInTok{print}\NormalTok{(}\StringTok{'x'}\NormalTok{)}
    \BuiltInTok{print}\NormalTok{(}\StringTok{'y'}\NormalTok{)}
    \BuiltInTok{print}\NormalTok{(}\StringTok{'z'}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\end{itemize}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{k}{def} \PY{n+nf}{simple\PYZus{}coroutine}\PY{p}{(}\PY{p}{)}\PY{p}{:}
            \PY{k}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZhy{}\PYZgt{} start}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
            \PY{n}{x} \PY{o}{=} \PY{k}{yield}
            \PY{k}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZhy{}\PYZgt{} recived}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{x}\PY{p}{)}
        
        \PY{n}{sc} \PY{o}{=} \PY{n}{simple\PYZus{}coroutine}\PY{p}{(}\PY{p}{)}
        
        \PY{n+nb}{next}\PY{p}{(}\PY{n}{sc}\PY{p}{)}
        \PY{n}{sc}\PY{o}{.}\PY{n}{send}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{test!}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
\end{Verbatim}
...
\end{itemize}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{k}{def} \PY{n+nf}{consumer}\PY{p}{(}\PY{p}{)}\PY{p}{:}
            \PY{n}{r} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZsq{}}
            \PY{k}{while} \PY{n+nb+bp}{True}\PY{p}{:}
                \PY{n}{n} \PY{o}{=} \PY{k}{yield} \PY{n}{r}
                \PY{k}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{[CONSUMER] Consuming }\PY{l+s+si}{\PYZpc{}s}\PY{l+s+s1}{...}\PY{l+s+s1}{\PYZsq{}} \PY{o}{\PYZpc{}} \PY{n}{n}\PY{p}{)}
                \PY{n}{r} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{200 OK}\PY{l+s+s1}{\PYZsq{}}
        
        \PY{k}{def} \PY{n+nf}{produce}\PY{p}{(}\PY{n}{c}\PY{p}{)}\PY{p}{:}
            \PY{n}{c}\PY{o}{.}\PY{n}{send}\PY{p}{(}\PY{n+nb+bp}{None}\PY{p}{)}
            \PY{n}{n} \PY{o}{=} \PY{l+m+mi}{0}
            \PY{k}{while} \PY{n}{n} \PY{o}{\PYZlt{}} \PY{l+m+mi}{5}\PY{p}{:}
                \PY{n}{n} \PY{o}{=} \PY{n}{n} \PY{o}{+} \PY{l+m+mi}{1}
                \PY{k}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{[PRODUCER] Producing }\PY{l+s+si}{\PYZpc{}s}\PY{l+s+s1}{...}\PY{l+s+s1}{\PYZsq{}} \PY{o}{\PYZpc{}} \PY{n}{n}\PY{p}{)}
                \PY{n}{r} \PY{o}{=} \PY{n}{c}\PY{o}{.}\PY{n}{send}\PY{p}{(}\PY{n}{n}\PY{p}{)}
                \PY{k}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{[PRODUCER] Consumer return: }\PY{l+s+si}{\PYZpc{}s}\PY{l+s+s1}{\PYZsq{}} \PY{o}{\PYZpc{}} \PY{n}{r}\PY{p}{)}
            \PY{n}{c}\PY{o}{.}\PY{n}{close}\PY{p}{(}\PY{p}{)}
        
        \PY{n}{c} \PY{o}{=} \PY{n}{consumer}\PY{p}{(}\PY{p}{)}
        \PY{n}{produce}\PY{p}{(}\PY{n}{c}\PY{p}{)}
\end{Verbatim}
...
\paragraph{asyncio add task example}\label{asyncio-add-task-example}}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{k+kn}{import} \PY{n+nn}{threading}
        \PY{k+kn}{import} \PY{n+nn}{asyncio}
        
        \PY{n+nd}{@asyncio.coroutine}
        \PY{k}{def} \PY{n+nf}{hello}\PY{p}{(}\PY{p}{)}\PY{p}{:}
            \PY{k}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Hello world! (}\PY{l+s+si}{\PYZpc{}s}\PY{l+s+s1}{)}\PY{l+s+s1}{\PYZsq{}} \PY{o}{\PYZpc{}} \PY{n}{threading}\PY{o}{.}\PY{n}{currentThread}\PY{p}{(}\PY{p}{)}\PY{p}{)}
            \PY{k}{yield from} \PY{n}{asyncio}\PY{o}{.}\PY{n}{sleep}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{)}
            \PY{k}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Hello again! (}\PY{l+s+si}{\PYZpc{}s}\PY{l+s+s1}{)}\PY{l+s+s1}{\PYZsq{}} \PY{o}{\PYZpc{}} \PY{n}{threading}\PY{o}{.}\PY{n}{currentThread}\PY{p}{(}\PY{p}{)}\PY{p}{)}
        
        \PY{n}{loop} \PY{o}{=} \PY{n}{asyncio}\PY{o}{.}\PY{n}{get\PYZus{}event\PYZus{}loop}\PY{p}{(}\PY{p}{)}
        \PY{n}{tasks} \PY{o}{=} \PY{p}{[}\PY{n}{hello}\PY{p}{(}\PY{p}{)}\PY{p}{,} \PY{n}{hello}\PY{p}{(}\PY{p}{)}\PY{p}{]}
        \PY{n}{loop}\PY{o}{.}\PY{n}{run\PYZus{}until\PYZus{}complete}\PY{p}{(}\PY{n}{asyncio}\PY{o}{.}\PY{n}{wait}\PY{p}{(}\PY{n}{tasks}\PY{p}{)}\PY{p}{)}
        \PY{n}{loop}\PY{o}{.}\PY{n}{close}\PY{p}{(}\PY{p}{)}
\end{Verbatim}


    \hypertarget{refactor-the-before-example-code}{%
\paragraph{refactor the before example
code}\label{refactor-the-before-example-code}}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{k+kn}{import} \PY{n+nn}{asyncio}
        \PY{k+kn}{import} \PY{n+nn}{time}
        
        \PY{n+nd}{@asyncio.coroutine}
        \PY{k}{def} \PY{n+nf}{wget}\PY{p}{(}\PY{n}{host}\PY{p}{)}\PY{p}{:}
            \PY{c+c1}{\PYZsh{}print(\PYZsq{}wget \PYZpc{}s...\PYZsq{} \PYZpc{} host)}
            \PY{n}{connect} \PY{o}{=} \PY{n}{asyncio}\PY{o}{.}\PY{n}{open\PYZus{}connection}\PY{p}{(}\PY{n}{host}\PY{p}{,} \PY{l+m+mi}{80}\PY{p}{)}
            \PY{n}{reader}\PY{p}{,} \PY{n}{writer} \PY{o}{=} \PY{k}{yield from} \PY{n}{connect}
            \PY{n}{header} \PY{o}{=} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{GET / HTTP/1.0}\PY{l+s+se}{\PYZbs{}r}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s1}{Host: }\PY{l+s+si}{\PYZpc{}s}\PY{l+s+se}{\PYZbs{}r}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+se}{\PYZbs{}r}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s1}{\PYZsq{}} \PY{o}{\PYZpc{}} \PY{n}{host}
            \PY{n}{writer}\PY{o}{.}\PY{n}{write}\PY{p}{(}\PY{n}{header}\PY{o}{.}\PY{n}{encode}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{utf\PYZhy{}8}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{)}
            \PY{k}{yield from} \PY{n}{writer}\PY{o}{.}\PY{n}{drain}\PY{p}{(}\PY{p}{)}
            \PY{k}{while} \PY{n+nb+bp}{True}\PY{p}{:}
                \PY{n}{line} \PY{o}{=} \PY{k}{yield from} \PY{n}{reader}\PY{o}{.}\PY{n}{readline}\PY{p}{(}\PY{p}{)}
                \PY{k}{if} \PY{n}{line} \PY{o}{==} \PY{l+s+sa}{b}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+se}{\PYZbs{}r}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                    \PY{k}{break}
                \PY{c+c1}{\PYZsh{}print(\PYZsq{}\PYZpc{}s header \PYZgt{} \PYZpc{}s\PYZsq{} \PYZpc{} (host, line.decode(\PYZsq{}utf\PYZhy{}8\PYZsq{}).rstrip()))}
            \PY{c+c1}{\PYZsh{} Ignore the body, close the socket}
            \PY{n}{writer}\PY{o}{.}\PY{n}{close}\PY{p}{(}\PY{p}{)}
        
        \PY{n}{start\PYZus{}time} \PY{o}{=} \PY{n}{time}\PY{o}{.}\PY{n}{time}\PY{p}{(}\PY{p}{)}
        \PY{n}{loop} \PY{o}{=} \PY{n}{asyncio}\PY{o}{.}\PY{n}{get\PYZus{}event\PYZus{}loop}\PY{p}{(}\PY{p}{)}
        \PY{n}{tasks} \PY{o}{=} \PY{p}{[}\PY{n}{wget}\PY{p}{(}\PY{n}{host}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{10.56.78.25}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{l+m+mi}{10}\PY{p}{)}\PY{p}{]}
        \PY{n}{loop}\PY{o}{.}\PY{n}{run\PYZus{}until\PYZus{}complete}\PY{p}{(}\PY{n}{asyncio}\PY{o}{.}\PY{n}{wait}\PY{p}{(}\PY{n}{tasks}\PY{p}{)}\PY{p}{)}
        \PY{n}{loop}\PY{o}{.}\PY{n}{close}\PY{p}{(}\PY{p}{)}
        \PY{k}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{use time:}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{time}\PY{o}{.}\PY{n}{time}\PY{p}{(}\PY{p}{)} \PY{o}{\PYZhy{}} \PY{n}{start\PYZus{}time}\PY{p}{)}
\end{Verbatim}
